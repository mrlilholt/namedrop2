...
function showSuccessGif() {
    ...
    gifContainer.style.top = `${rect.top + window.scrollY - 100}px`; // Slightly above the image
    gifContainer.style.left = `${rect.left + window.scrollX + 60}px`; // Slightly to the left
